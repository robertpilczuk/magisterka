...
const translations = {
    ...
    PL: {
        ...
        evaluation: {
            ...
            hint_hits: 'Liczba trafień — filmy które model polecił i które użytkownik faktycznie polubił',
            hint_rmse: 'Błąd predykcji oceny na zbiorze testowym',
            hint_mae: 'Średnia bezwzględna różnica ocen',
            liked_verb: 'polubił',
            test_set: 'Zbiór testowy',
            movies_unit: 'filmów',
            liked_count_label: 'Polubił',
            model_rec_label: 'Model polecił',
            quality_good: '✅ Dobry wynik',
            quality_mid: '🟡 Średni wynik',
            quality_poor: '❌ Słaby wynik',
            table_heading: 'Filmy ze zbioru testowego — predykcja vs rzeczywistość',
            legend_hit: '🎯 Trafienie (model polecił + user polubił)',
            legend_false_alarm: '❌ Fałszywy alarm (model polecił, user nie polubił)',
            legend_miss: '⚠️ Przeoczenie (model nie polecił, user polubił)',
        },
    ...
    EN: {
        ...
        evaluation: {
            ...
            hint_hits: 'Number of hits — films the model recommended that the user actually liked',
            hint_rmse: 'Rating prediction error on the test set',
            hint_mae: 'Mean absolute difference between ratings',
            liked_verb: 'liked',
            test_set: 'Test set',
            movies_unit: 'films',
            liked_count_label: 'Liked',
            model_rec_label: 'Model recommended',
            quality_good: '✅ Good result',
            quality_mid: '🟡 Average result',
            quality_poor: '❌ Poor result',
            table_heading: 'Test-set films — prediction vs reality',
            legend_hit: '🎯 Hit (model recommended + user liked)',
            legend_false_alarm: '❌ False alarm (model recommended, user did not like)',
            legend_miss: '⚠️ Miss (model did not recommend, user liked)',
        },
